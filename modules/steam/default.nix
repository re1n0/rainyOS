...
mkTarget "steam" {
  ...
  nixos = {
    ...
    programs.steam = {
      ...
      extraCompatPackages = [config.compatTool.default];
  ...
  hm = {
    ...
    programs.steam.config = {
      enable = true;
      defaultCompatTool = config.compatTool.default;
    ...
    persist.files = [
      ".local/share/millennium/plugins/non-steam-playtimes/sessions.json"
    ];
  };
}
